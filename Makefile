...
#    Updated: 2018/11/29 12:55:43 by erli             ###   ########.fr        #
#                                                                              #
#******************************************************************************#
...
SRCS		=		char_in_str.c		ft_memalloc.c		ft_memalloc_c.c		\
					ft_printf.c			ft_strdup.c			ft_strjoin.c		\
					ft_strjoinfree.c	ft_strlen.c			ft_strncmp.c		\
					ft_strsub.c													\
